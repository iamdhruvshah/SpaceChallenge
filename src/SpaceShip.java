public interface SpaceShip {
    ...
    /*A method that takes an Item as an argument and returns true if the rocket can carry such item or false if it
     will exceed the weight limit.*/
    boolean canCarry(Item randomItem);

    //A method that also takes an Item object and updates the current weight of the rocket.
    void carry(Item randomItem);
